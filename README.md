...
- **Internet radio:** live MP3 stations over Wi-Fi on the ESP32-S3-LCD-0.85 speaker, including Radio Farda, Radio Yar and Navahang. Requires base firmware v1.1.12 (project ABI 5). Select a starting station in Projects; hold + or − on the board to change stations, or tap to adjust volume. The firmware decodes audio in a background task and stops playback when the project is unloaded. Station URLs are direct MP3 streams and may change over time.
